...
public abstract class ActionScript : MonoBehaviour
{
    ...
    protected void CreateMissText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "MISS", Color.red, 6f, 0.3f));
    }
    ...
    protected void CreateGuardText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "GUARD", Color.gray, 6f, 0.3f));
    }
    ...
    protected void CreateCritText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "CRIT!", Color.blue, 9f, 0.3f));
    }

    protected void CreateKOdText(BattleUnit target)
    {
        //FloatingTextPopup.Create(GetPositionAboveUnit(target), "KO'd!", Color.red, 9f, 1f);
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "KO'd!", Color.red, 9f, 0.3f));
    }
    ...
    protected void CreateWeaknessText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "WEAK!", Color.blue, 9f, 0.3f));
    }
    ...
    protected void CreateResistanceText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "RESIST", Color.gray, 6f, 0.3f));
    }
    ...
    protected void CreateNullifyText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "IMMUNE", Color.gray, 6f, 0.3f));
    }
    ...
    protected void CreateAbsorbText(BattleUnit target)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), "ABSORB", Color.green, 6f, 0.3f));
    }
    ...
    protected void CreateTotalDamageText(BattleUnit target, int damage)
    {
        ...
        TextPopups.AddPopupParametersToQueue(new FloatingTextPopupParameters(GetPositionAboveUnit(target), $"{damage} TOTAL", Color.yellow, 9f, 0.6f));
    }
